ig.module('game.entities.Boss')
  ...
  .defines(function(){
		...
		size: {x:16,y:40},  /* the default size */
			offset:{x:8,y:4},   /* shift the box to detect collisions a bit */
		health: 300, 		/* And make him healthier than every other enemy*/
		...
		animSheet: new ig.AnimationSheet('media/enemyboss.png',32,48),	/* where to find the animation sheet */
		...
		update: function(){
			...
			/* lett the artificial intelligence engine tell us what to do */
